...
- [ ] exp11-sc-best-stack: 트랙 B1 — 최적 추론 스택 확정. `remote/eval_vllm.py --mode sc --n 16` (베이스, 어댑터 없음) 실행 — 개선된 스크립트가 n=16 다수결과 가중 투표를 함께 출력. 수치(n16 다수결/가중)를 exp10의 n8 수치와 표로 묶어 기록. 목표: 가중 n16이 76%+인지 확인
